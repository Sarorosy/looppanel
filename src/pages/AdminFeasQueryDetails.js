...
const AdminFeasQueryDetails = ({ onClose, queryId, quotationId, finalFunction }) => {
        ...
        >
            ...
            {loading ? (
                ...
                <div className=' flex items-start justify-between space-x-1 pnav text-black'>
                                ...
                                {queryInfo.tags && queryInfo.tags.length > 0 ? (
                                    <div className="">
                                        {queryInfo.tags.map((tag, index) => (
                                            <span
                                                key={index}
                                                className="bg-yellow-500 px-1 d-inline-block rounded text-white mr-1 mb-1 d-inline-block"
                                            >
                                                {tag}
                                            </span>
                                        ))}
                    ...
                    <AdminFeasViewDetails queryId={queryInfo.assign_id} quotationId={quotationId} userType={userObject.fld_admin_type} finalFunction={finalFunction}/>
...
export default AdminFeasQueryDetails;