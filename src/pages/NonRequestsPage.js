...
import NonRequestDetail from './NonRequestDetail';
const socket = getSocket();

const NonRequestsPage = ({ onClose, sharelinkrefid, sharelinkquoteid }) => {
    ...
    const fetchQuoteSummary = async () => {
        ...
        try {
            const response = await fetch(
                'https://loopback-skci.onrender.com/api/scope/getAllNonRequests',
                {
    ...
    return (
        ...
        >
            <div className='bg-blue-400 text-white py-3 mb-3'>
                ...
                <h2 className="text-xl font-semibold">Non Requests</h2>
...
export default NonRequestsPage;
