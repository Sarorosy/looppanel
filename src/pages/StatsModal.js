...
const StatsModal = ({
    ...
    const tabs = [
        { key: "submitted", label: "Submitted", data: submitted_quote_ids },
        { key: "discount", label: "Discount Submitted", data: discount_quote_ids },
    ];
            ...
            >
                ...
                >
                    ...
                    <div className="flex justify-between items-center px-2 py-2 border-b">
                        <h2 className="text-lg font-semibold">Quote IDs</h2>
                    ...
                    <div className="flex border-b">
                        {tabs.map((t) => (
                            <button
                                key={t.key}
                                className={`flex-1 py-1 f-12 font-medium ${tab === t.key
